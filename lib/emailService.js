...
const generateInvitationEmailTemplate = (inviterName, organizationName, invitationToken, employeeName) => {
  ...
  return `
    ...
    <body>
      <div class="container">
        ...
        <div class="footer">
          <p>This invitation was sent to ${employeeName} (${invitationToken.slice(0, 8)}...)</p>
...
export const sendInvitationEmail = async (invitationData) => {
  try {
    ...
    const mailOptions = {
      ...
      html: generateInvitationEmailTemplate(inviterName, organizationName, invitationToken, name),
    ...
    // For other email errors, provide the manual link
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="${invitationUrl}" style="background: #667eea; color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; font-weight: bold;">Accept Invitation</a>
          </div>
...
// Check if email is configured (non-throwing version)
