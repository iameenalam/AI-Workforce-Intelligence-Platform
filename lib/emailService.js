    ...
    <body>
      <div class="container">
        <div class="header">
          ...
          <p>Join ${organizationName} as an employee</p>
        </div>
        <div class="content">
          <h2>Hello ${employeeName}!</h2>
          <p>Great news! <strong>${inviterName}</strong> has invited you to join <strong>${organizationName}</strong> as an employee.</p>
