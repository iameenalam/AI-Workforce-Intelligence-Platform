...
import { loginUser, loginWithGoogle } from "@/redux/action/user";
          ...
          <motion.div variants={FADE_IN_ANIMATION_VARIANTS} className="w-full">
            ...
            >
              ...
              <button
                ...
                disabled={localLoading === "login" || localLoading === "google"}
              >
                {localLoading === "login" ? "Logging in..." : "Log In"}
              </button>
            </form>
            ...
            <button
              ...
              onClick={() => {
                if (!localLoading) {
                  document.getElementById("google_login_real_btn")?.querySelector("div[role=button]")?.click();
                }
              }}
            ...
            >
              ...
              {localLoading === "google" ? "Signing in..." : "Sign in with Google"}
            </button>
            <div id="google_login_real_btn" className="absolute left-[-9999px] w-0 h-0 overflow-hidden">
